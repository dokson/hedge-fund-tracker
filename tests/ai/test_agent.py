...
class TestGetPromiseScoreWeights(unittest.TestCase):
    ...
    def test_returns_weights_on_valid_response(
    ...
    @patch("app.ai.agent.ResponseParser.extract_and_decode_toon")
    @patch("app.ai.agent.promise_score_weights_prompt")
    def test_raises_invalid_response_error_when_weights_sum_invalid(
        self, mock_prompt, mock_parse, mock_val_weights
    ):
        """
    ...
    @patch("app.ai.agent.ResponseParser.extract_and_decode_toon")
    @patch("app.ai.agent.promise_score_weights_prompt")
    def test_raises_invalid_response_error_when_metrics_unrecognized(
        self, mock_prompt, mock_parse, mock_val_weights, mock_val_metrics
    ):
        """
    ...
    @patch("app.ai.agent.ResponseParser.extract_and_decode_toon")
    @patch("app.ai.agent.promise_score_weights_prompt")
    def test_coerces_string_numeric_weights_to_float(
        self, mock_prompt, mock_parse, mock_val_weights, mock_val_metrics
    ):
        """
    ...
    @patch("app.ai.agent.ResponseParser.extract_and_decode_toon")
    @patch("app.ai.agent.promise_score_weights_prompt")
    def test_raises_invalid_response_error_on_non_numeric_weight(
        self, mock_prompt, mock_parse, mock_val_weights
    ):
        """
