...
class TestGithub(unittest.TestCase):
    ...
    def test_alert_creates_github_issue_successfully(self, mock_getenv, mock_print, mock_post):
        """
    ...
    @patch('builtins.print')
    @patch('app.utils.github.os.getenv')
    def test_alert_handles_api_error(self, mock_getenv, mock_print, mock_post):
        """
